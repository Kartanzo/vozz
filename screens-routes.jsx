      ...
      <div className="section-title">
        ...
        <div className="row gap-2">
          ...
          <button className="btn btn-sm" onClick={() => {
            ...
            const a = document.createElement("a"); a.href = url; a.download = "vozz_rota.csv"; a.click();
            URL.revokeObjectURL(url);
          }}><Icon name="export" size={13}/> Exportar rota</button>
          <button className="btn btn-sm btn-primary" onClick={() => {
            if (!stops.length) { vozzAlert("Adicione paradas à rota antes de salvar.", "Rota vazia"); return; }
            vozzAlert(`${stops.length} paradas · ${totalKm} km · ${Math.floor(totalMin/60)}h${totalMin%60}min`, "📅 Rota salva na agenda");
            ...
            <div className="card" style={{ background: "var(--brand-grad-soft)", borderColor: "transparent" }}>
              <div style={{ padding: 16 }}>
                <div className="row gap-2 mb-2">
                  ...
                  <span style={{ fontWeight: 700, fontSize: 13 }}>Sugestão Vozz IA</span>
                </div>
