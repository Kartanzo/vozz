// ============================================================
// VOZZ CRM — Canal Misto · Interno × Representante Externo
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16, alignItems: "start" }}>
        ...
        <div className="col gap-3">
          ...
          <div className="card" style={{ padding: 14, background: "var(--brand-grad-soft)", borderColor: "transparent" }}>
            <div className="row gap-2 mb-2"><Icon name="sparkles" size={14}/><b style={{ fontSize: 13 }}>Regra Vozz de Deal Registration</b></div>
