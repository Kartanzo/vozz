// ============================================================
// 3LACKD CRM — Check-in de Visitas (web)
// Registra início, observações, resultado e próximos passos.
// ============================================================

const CHECKIN_KEY = "blackd_checkins";
...
const CheckIn = ({ t, lang }) => {
 ...
 const saveActive = () => {
 if (!active.resultado) { blackdAlert("Selecione um resultado antes de salvar.", "Faltou um campo"); return; }
 ...
 onClick={async () => { if (await blackdConfirm("Apagar todo o histórico de check-ins?", "Limpar histórico")) { setCheckins([]); saveCheckins([]); } }}
