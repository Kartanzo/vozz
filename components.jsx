// ============================================================
// VOZZ CRM — Icons + shared UI primitives
// ============================================================
...
// Brand mark — the cluster of dots from the Vozz logo
const VozzMark = ({ size = 24 }) => (
...
// API: vozzAlert(msg) · vozzConfirm(msg) · vozzPrompt(msg, default)
// Todas retornam Promise.
// ============================================================
const _dialogListeners = [];
window.vozzDialog = (opts) => new Promise(resolve => {
...
window.vozzAlert   = (message, title) => window.vozzDialog({ type: "alert",   title: title || "Aviso",     message });
window.vozzConfirm = (message, title) => window.vozzDialog({ type: "confirm", title: title || "Confirmar", message });
window.vozzPrompt  = (message, defaultValue, title) => window.vozzDialog({ type: "prompt", title: title || "Entrada", message, defaultValue: defaultValue || "" });
...
Object.assign(window, {
  Icon, VozzMark, Avatar, AvatarStack, DialogHost,
