// ============================================================
// VOZZ CRM — Coverage / Abrangência (world map)
// ============================================================
      ...
      <div className="section-title">
        ...
        <div className="row gap-2">
          ...
          <button className="btn btn-sm" onClick={() => {
            ...
            const a = document.createElement("a"); a.href = url; a.download = "vozz_abrangencia.csv"; a.click();
      ...
      <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div className="row gap-2 mt-2">
          <button className="btn btn-sm btn-primary flex-1"
                  onClick={() => vozzAlert(`Responsável: ${rep.name}\nStatus: ${pin.status}\nSegmento: ${seg?.pt || "—"}`, `Contatar · ${pin.city}`)}>
